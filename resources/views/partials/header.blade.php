					...
					<div class="row">
						<div class="col-md-3">
							<div class="header-logo">
								<a href="#" class="logo">
									<img src="storage/products/logo.png" alt="Logo Electro">
								</a>
							</div>
						</div>
						<div class="col-md-6">
										...
										<div class="cart-list">
											<div class="product-widget">
												<div class="product-img">
													<img src="storage/products/product01.png" alt="Laptop UltraBook ZenMax">
												</div>
											...
											<div class="product-widget">
												<div class="product-img">
													<img src="storage/products/product02.png" alt="Smartphone Galaxy Pro">
												</div>
												<div class="product-body">
